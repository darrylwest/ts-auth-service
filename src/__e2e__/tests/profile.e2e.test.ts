  ...
  describe('PUT /api/profile', () => {
    describe('Authentication', () => {
      ...
      it('should return 403 when invalid token provided', async () => {
        ...
        const response = await apiClient
          .withAuth(invalidToken)
          .put('/api/profile', { name: 'Updated Name' });
    ...
    describe('Successful Updates', () => {
      ...
      it('should preserve existing data when updating partial fields', async () => {
        ...
        const currentResponse = await apiClient
          .withAuth(userToken)
          .get('/api/profile');
    ...
    describe('Error Conditions', () => {
      ...
      it('should return 500 when database error occurs', async () => {
        ...
        const response = await apiClient
          .withAuth(userToken)
          .put('/api/profile', { name: 'Test Database Error' });

  ...
  describe('GET /api/admin/dashboard', () => {
    describe('Authentication Required', () => {
      ...
      it('should return 403 when invalid token provided', async () => {
        ...
        const response = await apiClient.withAuth(invalidToken).get('/api/admin/dashboard');
      ...
      it('should return 403 when malformed token provided', async () => {
        ...
        const response = await apiClient.withAuth(malformedToken).get('/api/admin/dashboard');
    ...
    describe('Authorization - Role-Based Access', () => {
      it('should return 403 when regular user tries to access admin dashboard', async () => {
        ...
        const response = await apiClient.withAuth(userToken).get('/api/admin/dashboard');
      ...
      it('should return 403 when new user tries to access admin dashboard', async () => {
        ...
        const response = await apiClient.withAuth(newUserToken).get('/api/admin/dashboard');
      ...
      it('should allow admin user to access dashboard', async () => {
        ...
        const response = await apiClient.withAuth(adminToken).get('/api/admin/dashboard');
      ...
      it('should allow super-admin user to access dashboard', async () => {
        ...
        const response = await apiClient.withAuth(superAdminToken).get('/api/admin/dashboard');
    ...
    describe('Role Hierarchy Testing', () => {
      it('should verify that admin role has required permissions', async () => {
        ...
        const profileResponse = await apiClient.withAuth(adminToken).get('/api/profile');
        expect(profileResponse.status).toBe(200);

        const dashboardResponse = await apiClient.withAuth(adminToken).get('/api/admin/dashboard');
      ...
      it('should verify that super-admin role has required permissions', async () => {
        ...
        const profileResponse = await apiClient.withAuth(superAdminToken).get('/api/profile');
        expect(profileResponse.status).toBe(200);

        const dashboardResponse = await apiClient.withAuth(superAdminToken).get('/api/admin/dashboard');
        expect(dashboardResponse.status).toBe(200);
      });
      ...
      it('should verify that regular user can only access profile', async () => {
        ...
        const profileResponse = await apiClient.withAuth(userToken).get('/api/profile');
        expect(profileResponse.status).toBe(200);

        const dashboardResponse = await apiClient.withAuth(userToken).get('/api/admin/dashboard');
